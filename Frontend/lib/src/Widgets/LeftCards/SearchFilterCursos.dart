...
class SearchFilterCursos extends StatefulWidget {
  const SearchFilterCursos({Key? key}) : super(key: key);

  @override
  _SearchFilterCursosState createState() => _SearchFilterCursosState();
}

class _SearchFilterCursosState extends State<SearchFilterCursos> {
  String? selectedRol;
